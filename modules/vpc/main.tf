...
resource "aws_subnet" "pub_sub_2b" {
 ...
 #create route table and add public_route_table 
...
# attach that route table to the subnet   "Public subnet to route table"
...
# attach public subnet az2 to "public route table"
